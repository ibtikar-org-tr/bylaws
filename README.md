...
``` mermaid
  flowchart RL
    ...
    projects --> p2(منصّة تكنوفست بالعربي)
    projects --> p3(مكتب التحوّل الرّقمي)
    projects --> p4(المشاريع الأخرى)
    
    scientific --> s1(الأندية)
    
    information --> i1(مكتب العلاقات)
    information --> i2(المكتب التنظيمي)
```
...
projects --> p2(مسؤول منصّة تكنوفست بالعربي)
projects --> p2(مسؤول مكتب التحوّل الرقمي)
projects --> p4(مسؤولو المشاريع الأخرى)

logistics --> l1(مسؤول مكتب الأنشطة)
logistics --> l2(مسؤول المكتب الإعلامي)

information --> i1(مسؤول مكتب العلاقات)
information --> i2(مسؤول المكتب التنظيمي)
end
```
...
- **`4.1.2`	ااا**:
  - سوف يتم ملء هذا القسم قريباً TODO

### `4.2`	 البند الثّاني: حقوق وواجبات الأعضاء:

#### `4.2.1`	الحقوق:

  - الأولويّة _عن غير المنتسبين_ في المشاركة والاستفادة من الفعاليّات والخدمات التي يقدّمها التجمّع
...
#### `4.2.2`	الواجبات:
  ...
  - في حال كان متطوّع: التّطوّع والمساعدة في إنجاز المخطّطات ضمن التّقسيمات الإداريّة المتواجد ضمنها
  - في حال كان متطوّع: الالتزام بالمهام المكلّف بها ضمن المكتب/النادي/المشروع الذي ينتسب له


### `4.3`	البند الثّالث: إلغاء العضويّة
#### `4.3.1`	من قبل الإدارة:
- يقوم مجلس الإدارة بإلغاء عضويّة أي عضو في الحالات الآتية:
